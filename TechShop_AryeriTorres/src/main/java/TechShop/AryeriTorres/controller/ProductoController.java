...
import TechShop.AryeriTorres.service.CategoriaService;
import TechShop.AryeriTorres.service.ProductoService;
...
public class ProductoController {
    ...
    public String modificar(@PathVariable("idProducto") Integer idProducto,
        ...
        if (productoOpt.isEmpty()) {
            redirectAttributes.addFlashAttribute("error", messageSource.getMessage("producto.noencontrado", null, Locale.getDefault()));
            return "redirect:/producto/listado";
        }
